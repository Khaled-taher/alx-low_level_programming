...
list_t *bulid_path(list_t **head, char *path);
char *_getenv(extern *environ[], char *name);
int _setenv(char **environ, const char *name, const char *value, int overwrite);
int _setenv_helper1(char **environ, const char *name, const char *value, char **new_environ, int j);
int _setenv_helper2(char **environ, const char *name, const char *value, char **new_environ, int j);
int _unsetenv(char **environ, const char *name);
void _free_environ(char **environ);
char ** _cpy_environ(extern char **environ);
